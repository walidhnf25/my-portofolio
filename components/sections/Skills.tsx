...
export default function Skills() {
  return (
    <section id="skills" className="relative py-16 overflow-hidden bg-[#FAF8F5]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <p className="font-serif text-[15px] leading-[1.75] text-[#333] max-w-4xl first-letter:text-5xl first-letter:font-black first-letter:float-left first-letter:mr-3 first-letter:mt-1 first-letter:text-[#DA291C] first-letter:leading-[0.8]">
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 lg:col-span-7 space-y-6">
            {skillCategories.filter(s => s.featured).map((category, index) => (
              <motion.article
                ...
                viewport={{ once: true }}
                className={`relative ${index === 0 ? 'border-l-4 border-[#DA291C] pl-6' : ''}`}
              >
                {index === 0 && (
                  <div className="absolute -top-2 left-0 bg-[#DA291C] text-white text-[9px] font-bold tracking-[0.2em] px-2 py-1">
                    FEATURED
                  </div>
                )}
                ...
                <div className="bg-white border-2 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                  ...
                  <div className="border-b-2 border-black pb-3 mb-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] tracking-[0.15em] uppercase text-[#DA291C]">
                        {category.subtitle}
                      </span>
                    </div>
                    <h3 className="font-serif text-xl sm:text-2xl font-black text-black mt-2">
                      {category.title}
                    </h3>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {category.skills.map((skill) => (
                      <span
                        key={skill}
                        className="text-[11px] px-3 py-1.5 bg-[#f5f3f0] border border-[#ddd] text-[#333] font-serif hover:bg-[#DA291C] hover:text-white hover:border-[#DA291C] transition-all duration-200 cursor-default"
                      >
                        {skill}
                      </span>
                    ))}
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="mt-8 p-6 bg-black text-white"
            >
              ...
              <p className="text-[10px] tracking-[0.2em] uppercase text-[#999] mt-3">
          ...
          >
            ...
            <div className="bg-[#DA291C] text-white p-4 mb-6">
            ...
            <div className="space-y-4">
              {skillCategories.filter(s => !s.featured).map((category, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="border border-[#ddd] p-4 bg-white hover:border-black transition-all duration-200"
                >
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <span className="text-[9px] tracking-[0.2em] uppercase text-[#999]">
                        {category.section}
                      </span>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {category.skills.map((skill) => (
                      <span
                        key={skill}
                        className="text-[10px] px-2 py-1 bg-[#faf8f5] border border-[#eee] text-[#555] font-serif"
                      >
                        {skill}
                      </span>
                    ))}
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="mt-6 bg-black text-white p-5"
            >
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="font-serif text-sm text-white/80">Programming Languages</span>
                  <span className="font-serif text-lg font-black text-[#DA291C]">11</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-serif text-sm text-white/80">Frameworks & Libraries</span>
                  <span className="font-serif text-lg font-black text-[#DA291C]">12</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-serif text-sm text-white/80">AI/ML Specializations</span>
                  <span className="font-serif text-lg font-black text-[#DA291C]">12</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-serif text-sm text-white/80">DevOps & Cloud</span>
                  <span className="font-serif text-lg font-black text-[#DA291C]">10</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-serif text-sm text-white/80">Methodologies</span>
                  <span className="font-serif text-lg font-black text-[#DA291C]">9</span>
                </div>
              </div>
